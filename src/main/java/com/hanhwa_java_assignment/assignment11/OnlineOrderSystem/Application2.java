package com.hanhwa_java_assignment.assignment11.OnlineOrderSystem;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        List<String> completedOrderIds = orders
                .stream()
                .filter(order -> order.getStatus() == "배송 완료")
        ...
        Comparator<Order> orderComparator = Comparator.comparingDouble(Order::getTotalAmount);
