package com.hanhwa_java_assignment.assignment11.MovieData;
...
public class Application4 {
    public static void main(String[] args) {
        ...
        List<String> highRatedActionMovies = movies
                .stream()
                .filter(movie -> movie.getGenre() == "액션" && movie.getRating() >= 8)
                .map(Movie::getTitle)
        ...
        Comparator<Movie> movieComparator = Comparator.comparingDouble(Movie::getRating);
        Map<String, String> topRatedMoviesByGenre = movies
                .stream()
                .collect(Collectors.groupingBy(Movie::getGenre,
                        Collectors.collectingAndThen(Collectors.maxBy(movieComparator),
