package com.hanhwa_java_assignment.assignment11.StudentGrade;

import com.hanhwa_java_assignment.assignment11.Employeedata.Employee;
...
public class Application3 {
    public static void main(String[] args) {
        ...
        Map<String, Double> averageScoreByStudent = students
                .stream()
                .collect(
                ...
                List<String> highScorersInMath = students
                        .stream()
                        .filter(student -> student.getSubject() == "수학" && student.getScore()>=90)
                        .map(Student::getName)
                        .collect(Collectors.toList());// 코드 작성

                        // 3. 가장 높은 평균 점수를 가진 학생의 이름을 반환
                        String topStudent = students
                                .stream()
