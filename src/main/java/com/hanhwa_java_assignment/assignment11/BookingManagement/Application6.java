package com.hanhwa_java_assignment.assignment11.BookingManagement;
...
public class Application6 {
    public static void main(String[] args) {
        ...
        List<String> booksByAuthor = books
                .stream()
                .filter(book -> book.getAuthor() == "J.K. 롤링")
                .map(Book::getTitle)
                .toList();// 코드 작성
        Comparator<Book> bookComaparator = Comparator.comparing(Book::getPrice);
